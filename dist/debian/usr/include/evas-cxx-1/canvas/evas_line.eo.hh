...
struct line
{
   ...
   struct address_of
   {
      operator ::evas::line*() const { return static_cast<::evas::line*>(static_cast<D const*>(this)->p); }
      operator ::evas::line const*() const { return static_cast<::evas::line const*>(static_cast<D const*>(this)->p); }
   };
      ...
      , EO_CXX_INHERIT(evas::object)
{
   //@{
   /**
      @brief Constructs a new evas::line object.

      Constructs a new evas::line object. If you want this object to be a child
      of another Eo object, use an @ref efl::eo::parent expression, like the example.

      Example:
      @code
      evas::line my_line(efl::eo::parent = parent_object);
      @endcode

      @see line(Eo* eo)
   */
   explicit line(::efl::eo::parent_type _p)
      : line(_ctors_call(_p))
   {}

   explicit line()
      : line(_ctors_call(::efl::eo::parent = nullptr))
   {}
   //@}
                        ...
                        ::efl::eo::callback_priorities::default_)
   {
      ...
      eo_do(_concrete_eo_ptr(),
            ...
            &::efl::eo::_detail::event_callback<::evas::line, function_type>, f.get()));
      return ::efl::eo::make_signal_connection
         (f, _concrete_eo_ptr(), &::efl::eo::_detail::event_callback<::evas::line, function_type>,
   ...
   /// @cond LOCAL
   struct address_of
      : ::eo_cxx::evas::line::address_of<address_of>
   ...
   {
      explicit address_of(::evas::line* p)
   ...
   struct address_const_of
      : ::eo_cxx::evas::line::address_const_of<address_const_of>
   ...
   {
      explicit address_const_of(::evas::line const* p)
...
private:
   ...
   {
      Eo* _ret_eo = eo_add_ref(EVAS_LINE_CLASS, _p._eo_raw);
...
static_assert(sizeof(::evas::line) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<::evas::line>::value, "");

}


#include "evas_line.eo.impl.hh"
