#ifndef EFL_GENERATED_EVAS_CANVAS3D_LIGHT_HH
#define EFL_GENERATED_EVAS_CANVAS3D_LIGHT_HH
...
extern "C"
{
#include "evas_canvas3d_light.eo.h"
}
...
struct light
{
   ...
   operator ::evas::canvas3d::light() const;
   operator ::evas::canvas3d::light&();
   operator ::evas::canvas3d::light const&() const;

   /// @cond LOCAL
   template <typename D>
   struct address_of
   {
      operator ::evas::canvas3d::light*() const { return static_cast<::evas::canvas3d::light*>(static_cast<D const*>(this)->p); }
      operator ::evas::canvas3d::light const*() const { return static_cast<::evas::canvas3d::light const*>(static_cast<D const*>(this)->p); }
   };
      ...
      , EO_CXX_INHERIT(evas::common_interface)
{
   //@{
   /**
      @brief Constructs a new evas::canvas3d::light object.

      Constructs a new evas::canvas3d::light object. If you want this object to be a child
      ...
      @see light(Eo* eo)
   */
   explicit light(::efl::eo::parent_type _p)
      : light(_ctors_call(_p))
   {}

   explicit light()
      : light(_ctors_call(::efl::eo::parent = nullptr))
   {}
   //@}
                        ...
                        ::efl::eo::callback_priorities::default_)
   {
      ...
      eo_do(_concrete_eo_ptr(),
            ...
            &::efl::eo::_detail::event_callback<::evas::canvas3d::light, function_type>, f.get()));
      return ::efl::eo::make_signal_connection
         (f, _concrete_eo_ptr(), &::efl::eo::_detail::event_callback<::evas::canvas3d::light, function_type>,
   ...
   /// @cond LOCAL
   struct address_of
      : ::eo_cxx::evas::canvas3d::light::address_of<address_of>
   ...
   {
      explicit address_of(::evas::canvas3d::light* p)
   ...
   struct address_const_of
      : ::eo_cxx::evas::canvas3d::light::address_const_of<address_const_of>
   ...
   {
      explicit address_const_of(::evas::canvas3d::light const* p)
...
private:
   ...
   {
      Eo* _ret_eo = eo_add_ref(EVAS_CANVAS3D_LIGHT_CLASS, _p._eo_raw);
...
static_assert(sizeof(::evas::canvas3d::light) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<::evas::canvas3d::light>::value, "");

} }


#include "evas_canvas3d_light.eo.impl.hh"

#endif // EFL_GENERATED_EVAS_CANVAS3D_LIGHT_HH
