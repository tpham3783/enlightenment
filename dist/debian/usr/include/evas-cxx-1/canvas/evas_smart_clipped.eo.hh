...
struct smart_clipped
{
   ...
   struct address_of
   {
      operator ::evas::smart_clipped*() const { return static_cast<::evas::smart_clipped*>(static_cast<D const*>(this)->p); }
      operator ::evas::smart_clipped const*() const { return static_cast<::evas::smart_clipped const*>(static_cast<D const*>(this)->p); }
   };
      ...
      , EO_CXX_INHERIT(evas::signal_interface)
{
   //@{
   /**
      @brief Constructs a new evas::smart_clipped object.

      Constructs a new evas::smart_clipped object. If you want this object to be a child
      of another Eo object, use an @ref efl::eo::parent expression, like the example.

      Example:
      @code
      evas::smart_clipped my_smart_clipped(efl::eo::parent = parent_object);
      @endcode

      @see smart_clipped(Eo* eo)
   */
   explicit smart_clipped(::efl::eo::parent_type _p)
      : smart_clipped(_ctors_call(_p))
   {}

   explicit smart_clipped()
      : smart_clipped(_ctors_call(::efl::eo::parent = nullptr))
   {}
   //@}
   ...
   smart_clipped(smart_clipped const& other)
      : smart_clipped(eo_ref(other._eo_ptr()))
   {}
                        ...
                        ::efl::eo::callback_priorities::default_)
   {
      ...
      eo_do(_concrete_eo_ptr(),
            ...
            &::efl::eo::_detail::event_callback<::evas::smart_clipped, function_type>, f.get()));
      return ::efl::eo::make_signal_connection
         (f, _concrete_eo_ptr(), &::efl::eo::_detail::event_callback<::evas::smart_clipped, function_type>,
   ...
   {
      explicit address_of(::evas::smart_clipped* p)
   ...
   {
      explicit address_const_of(::evas::smart_clipped const* p)
...
private:
   ...
   {
      Eo* _ret_eo = eo_add_ref(EVAS_SMART_CLIPPED_CLASS, _p._eo_raw);
...
static_assert(sizeof(::evas::smart_clipped) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<::evas::smart_clipped>::value, "");

}


#include "evas_smart_clipped.eo.impl.hh"
