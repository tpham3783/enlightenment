...
struct polygon
{
   ...
   struct address_of
   {
      operator ::evas::polygon*() const { return static_cast<::evas::polygon*>(static_cast<D const*>(this)->p); }
      operator ::evas::polygon const*() const { return static_cast<::evas::polygon const*>(static_cast<D const*>(this)->p); }
   };
      ...
      , EO_CXX_INHERIT(evas::object)
{
   //@{
   /**
      @brief Constructs a new evas::polygon object.

      Constructs a new evas::polygon object. If you want this object to be a child
      of another Eo object, use an @ref efl::eo::parent expression, like the example.

      Example:
      @code
      evas::polygon my_polygon(efl::eo::parent = parent_object);
      @endcode

      @see polygon(Eo* eo)
   */
   explicit polygon(::efl::eo::parent_type _p)
      : polygon(_ctors_call(_p))
   {}

   explicit polygon()
      : polygon(_ctors_call(::efl::eo::parent = nullptr))
   {}
   //@}
                        ...
                        ::efl::eo::callback_priorities::default_)
   {
      ...
      eo_do(_concrete_eo_ptr(),
            ...
            &::efl::eo::_detail::event_callback<::evas::polygon, function_type>, f.get()));
      return ::efl::eo::make_signal_connection
         (f, _concrete_eo_ptr(), &::efl::eo::_detail::event_callback<::evas::polygon, function_type>,
   ...
   /// @cond LOCAL
   struct address_of
      : ::eo_cxx::evas::polygon::address_of<address_of>
   ...
   {
      explicit address_of(::evas::polygon* p)
   ...
   struct address_const_of
      : ::eo_cxx::evas::polygon::address_const_of<address_const_of>
   ...
   {
      explicit address_const_of(::evas::polygon const* p)
...
private:
   ...
   {
      Eo* _ret_eo = eo_add_ref(EVAS_POLYGON_CLASS, _p._eo_raw);
...
static_assert(sizeof(::evas::polygon) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<::evas::polygon>::value, "");

}


#include "evas_polygon.eo.impl.hh"
