#ifndef EFL_GENERATED_EVAS_VG_HH
#define EFL_GENERATED_EVAS_VG_HH
...
struct vg
{
   ...
   operator ::evas::vg() const;
   operator ::evas::vg&();
   operator ::evas::vg const&() const;

   /// @cond LOCAL
   template <typename D>
   struct address_of
   {
      operator ::evas::vg*() const { return static_cast<::evas::vg*>(static_cast<D const*>(this)->p); }
      operator ::evas::vg const*() const { return static_cast<::evas::vg const*>(static_cast<D const*>(this)->p); }
   };
      ...
      , EO_CXX_INHERIT(evas::object)
{
   //@{
   /**
      @brief Constructs a new evas::vg object.

      Constructs a new evas::vg object. If you want this object to be a child
      of another Eo object, use an @ref efl::eo::parent expression, like the example.

      Example:
      @code
      evas::vg my_vg(efl::eo::parent = parent_object);
      @endcode

      @see vg(Eo* eo)
   */
   explicit vg(::efl::eo::parent_type _p)
      : vg(_ctors_call(_p))
   {}

   explicit vg()
      : vg(_ctors_call(::efl::eo::parent = nullptr))
   {}
   //@}
                        ...
                        ::efl::eo::callback_priorities::default_)
   {
      ...
      eo_do(_concrete_eo_ptr(),
            ...
            &::efl::eo::_detail::event_callback<::evas::vg, function_type>, f.get()));
      return ::efl::eo::make_signal_connection
         (f, _concrete_eo_ptr(), &::efl::eo::_detail::event_callback<::evas::vg, function_type>,
   ...
   /// @cond LOCAL
   struct address_of
      : ::eo_cxx::evas::vg::address_of<address_of>
   ...
   struct address_const_of
      : ::eo_cxx::evas::vg::address_const_of<address_const_of>
   ...
   {
      explicit address_const_of(::evas::vg const* p)
...
private:
   ...
   {
      Eo* _ret_eo = eo_add_ref(EVAS_VG_CLASS, _p._eo_raw);
...
static_assert(sizeof(::evas::vg) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<::evas::vg>::value, "");

}


#include "evas_vg.eo.impl.hh"

#endif // EFL_GENERATED_EVAS_VG_HH
