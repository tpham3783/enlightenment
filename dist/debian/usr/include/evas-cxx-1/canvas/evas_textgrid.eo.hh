...
struct textgrid
{
   ...
   struct address_of
   {
      operator ::evas::textgrid*() const { return static_cast<::evas::textgrid*>(static_cast<D const*>(this)->p); }
      operator ::evas::textgrid const*() const { return static_cast<::evas::textgrid const*>(static_cast<D const*>(this)->p); }
   };
      ...
      , EO_CXX_INHERIT(evas::object)
{
   //@{
   /**
      @brief Constructs a new evas::textgrid object.

      Constructs a new evas::textgrid object. If you want this object to be a child
      of another Eo object, use an @ref efl::eo::parent expression, like the example.

      Example:
      @code
      evas::textgrid my_textgrid(efl::eo::parent = parent_object);
      @endcode

      @see textgrid(Eo* eo)
   */
   explicit textgrid(::efl::eo::parent_type _p)
      : textgrid(_ctors_call(_p))
   {}

   explicit textgrid()
      : textgrid(_ctors_call(::efl::eo::parent = nullptr))
   {}
   //@}
                        ...
                        ::efl::eo::callback_priorities::default_)
   {
      ...
      eo_do(_concrete_eo_ptr(),
            ...
            &::efl::eo::_detail::event_callback<::evas::textgrid, function_type>, f.get()));
      return ::efl::eo::make_signal_connection
         (f, _concrete_eo_ptr(), &::efl::eo::_detail::event_callback<::evas::textgrid, function_type>,
   ...
   /// @cond LOCAL
   struct address_of
      : ::eo_cxx::evas::textgrid::address_of<address_of>
   ...
   {
      explicit address_of(::evas::textgrid* p)
   ...
   struct address_const_of
      : ::eo_cxx::evas::textgrid::address_const_of<address_const_of>
   ...
   {
      explicit address_const_of(::evas::textgrid const* p)
...
private:
   ...
   {
      Eo* _ret_eo = eo_add_ref(EVAS_TEXTGRID_CLASS, _p._eo_raw);
...
static_assert(sizeof(::evas::textgrid) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<::evas::textgrid>::value, "");

}


#include "evas_textgrid.eo.impl.hh"
