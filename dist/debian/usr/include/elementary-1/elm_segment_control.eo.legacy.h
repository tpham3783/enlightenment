 ...
 * @ingroup SegmentControl
 */
EAPI Elm_Object_Item *elm_segment_control_item_selected_get(const Elm_Segment_Control *obj);
 ...
 */
EAPI Elm_Object_Item *elm_segment_control_item_insert_at(Elm_Segment_Control *obj, Evas_Object *icon, const char *label, int idx);
 ...
 * @param[in] idx The index of the segment item.
 */
EAPI Elm_Object_Item *elm_segment_control_item_get(const Elm_Segment_Control *obj, int idx);
 ...
 */
EAPI Elm_Object_Item *elm_segment_control_item_add(Elm_Segment_Control *obj, Evas_Object *icon, const char *label);
